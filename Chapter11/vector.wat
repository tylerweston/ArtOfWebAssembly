(module
 ...
 (global $vector/Vector2d i32 (i32.const 3))
 ...
 (export "Vector2d#constructor" (func $export:vector/Vector2d#constructor))
 (export "Vector2d#Magnitude" (func $export:vector/Vector2d#Magnitude))
 (start $~start)
 (func $vector/Vector2d#set:x (param $0 i32) (param $1 f32)
  local.get $0
  local.get $1
  f32.store
 )
 (func $vector/Vector2d#set:y (param $0 i32) (param $1 f32)
  local.get $0
  local.get $1
  f32.store offset=4
 )
 ...
 (func $vector/Vector2d#get:x (param $0 i32) (result f32)
  local.get $0
  f32.load
 )
 (func $vector/Vector2d#get:y (param $0 i32) (result f32)
  local.get $0
  f32.load offset=4
 )
 (func $vector/Vector2d#Magnitude (param $0 i32) (result f32)
  (local $1 f32)
  local.get $0
  f32.load
  local.get $0
    ...
    block $~lib/arraybuffer/ArrayBufferView
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $vector/Vector2d $invalid
      end
      return
     end
     return
 ...
 (func $vector/Vector2d#constructor (param $0 i32) (param $1 f32) (param $2 f32) (result i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $0
  f32.const 0
  call $vector/Vector2d#set:x
  local.get $0
  f32.const 0
  call $vector/Vector2d#set:y
  local.get $0
  local.get $1
  call $vector/Vector2d#set:x
  local.get $0
 ...
 (func $export:vector/Vector2d#constructor (param $0 i32) (param $1 f32) (param $2 f32) (result i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $1
  local.get $2
  call $vector/Vector2d#constructor
  local.set $3
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
 ...
 (func $export:vector/Vector2d#Magnitude (param $0 i32) (result f32)
  (local $1 f32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $0
  call $vector/Vector2d#Magnitude
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
